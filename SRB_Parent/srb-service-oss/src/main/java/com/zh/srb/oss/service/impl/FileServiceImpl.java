...
public class FileServiceImpl implements FileService {
    ...
    public String upload(InputStream inputStream, String module, String fileName) {
        ...
        OSS ossClient = new OSSClientBuilder().build(
                ...
                "LTAI5tDEBi8uzT6tuxVzHkP7",
                "icSDxG8ZJb8B15pA1FuotkrFk26Nz5");

        OssProperties.BUCKET_NAME="zhouhui-srb";
        // 判断BUCKET_NAME是否存在
    ...
    public void removeFile(String url) {
        ...
        // 关闭OSSClient。  https://zhouhui-srb.oss-cn-beijing.aliyuncs.com/avtar/2025/12/15/81758929-dfa2-4187-8bb2-f359de32ab9f.jpg
        ossClient.shutdown();
    }
}
